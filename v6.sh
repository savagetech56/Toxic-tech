...
TIMES="10"
CHATID="7514935498"
KEY="7504651101:AAGdmW6x-cEfMSpz93UwFrEfkVanJ5WbO-s"
...
clear; clear; clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              TOXIC TECH                     \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/savagetech56/Toxic-tech/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/savagetech56/Toxic-tech/main/"
start=$(date +%s)
secs_to_human() {
...
wget raw.githubusercontent.com/savagetech56/Toxic-tech/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
print_success "UDP-CUSTOM BY TOXIC STORE VPN Installed"
clear
...
sleep 2
clear
echo -e "\033[93;1m Wait 4 seconds...\033[0m"
sleep 4
clear
echo ""
echo ""
