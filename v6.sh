...
clear; clear; clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              DARKANON AUTOSCRIPT                      \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/genome96/darkaons/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/genome96/darkaons/main/"
start=$(date +%s)
secs_to_human() {
...
wget raw.githubusercontent.com/genome96/darkaons/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
